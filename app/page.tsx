  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-pink-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-syne text-xl font-extrabold tracking-tight text-gray-900">Synthara</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#" className="gradient-bg text-white text-sm font-semibold px-4 py-2 rounded-full hover:opacity-90 transition-opacity">
              Get started →
            </a>
          </div>
        </div>
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="absolute top-40 right-0 w-[400px] h-[400px] rounded-full bg-pink-200 opacity-30 blur-3xl animate-pulse-pink pointer-events-none" />
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-100 glow-pink">
              ...
              <div className="bg-gray-50 px-4 py-3 border-b border-gray-100 flex items-center gap-2">
                ...
                <div className="flex-1 mx-4">
                  <div className="bg-white rounded-md px-3 py-1 text-xs text-gray-400 border border-gray-200 w-64 mx-auto text-center">
                    app.synthara.ai/workflows
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  {[
                    ...
                    <div key={stat.label} className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                      ...
                      <div className="font-syne text-2xl font-bold text-gray-900">{stat.value}</div>
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 flex-shrink-0">
                        <div className={`flex flex-col items-center gap-1 p-3 rounded-xl border min-w-[80px] ${step.active ? "bg-pink-50 border-pink-200" : step.done ? "bg-white border-gray-200" : "bg-gray-50 border-gray-100"}`}>
                          ...
                          {step.done && (
                            <div className={`w-4 h-4 rounded-full flex items-center justify-center ${step.active ? "bg-pink-500" : "bg-gray-300"}`}>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-syne text-5xl font-extrabold text-gray-900 leading-tight mb-6">
                Natural language.<br />
                <span className="gradient-text">Real automation.</span>
              </h2>
            ...
            <div className="relative">
                ...
                <div className="p-6 space-y-4">
                  <div className="bg-gray-800 rounded-xl p-4">
                    ...
                    <p className="text-white text-sm leading-relaxed">
                      &quot;When a new deal is marked Won in Salesforce, send a Slack message to #revenue, create a Notion page with deal notes, and schedule an onboarding call in Calendly.&quot;
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    {[
                      "Trigger: Salesforce deal stage → Won",
                      "Action: Post to Slack #revenue channel",
                      "Action: Create Notion page from template",
                      "Action: Schedule Calendly onboarding invite",
                    ].map((s, i) => (
              ...
              <div className="absolute -right-6 -bottom-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-4 w-48 animate-float-slow">
                ...
                <div className="font-syne text-2xl font-bold text-gray-900">12,491</div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">From small teams to large enterprises.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                price: "$79",
                sub: "per month",
                features: ["Unlimited workflows", "100K runs/month", "500+ integrations", "AI agents", "Priority support", "Custom webhooks"],
                cta: "Start trial",
                highlighted: true,
              },
              {
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="gradient-bg rounded-3xl p-16 text-center text-white relative overflow-hidden glow-pink">
            ...
            <div className="relative">
              <h2 className="font-syne text-5xl font-extrabold mb-6 leading-tight">
                Ready to automate<br />everything?
              </h2>
              <p className="text-pink-100 text-lg mb-10 max-w-lg mx-auto">
                Join thousands of teams who&apos;ve replaced repetitive work with intelligent automation. Setup takes minutes.
              </p>
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
                The AI automation platform for teams that move fast.
              </p>
            </div>
            {[
